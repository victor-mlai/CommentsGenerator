...
##(2) Encode the embedding output with a recurrent layer for
...
Learning_code2comments = False
if Learning_code2comments:
    with jsonlines.open('./juice-dataset/test.jsonl') as f:
        for line in f.iter():
...
model.save("translator_eng_fr_model")
...
model = keras.models.load_model("translator_eng_fr_model")
